...
# ADDED FOR AUTOGRADING PURPOSES ONLY
...
class REPL(cmd.Cmd):
    ...
    #########################
    @timeout_decorator.timeout(1800)  # 10 minutes MAX per input stream.
    #########################
    # END AUTOGRADING CODE  #
    #########################
...
# Does output redirection for autograding
class Tee(object):
    # Modified from https://stackoverflow.com/questions/34366763/input
    # -redirection-with-python
...
if __name__ == '__main__':
    ...
    HEADER = "Welcome to Stanford CS124's Chatbot Autograding."
    #########################
    # END AUTOGRADING CODE  #
    #########################
